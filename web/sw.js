const CACHE='lullaby-scene-site-v11';
const APP_SHELL=['/','/player/','/download/','/styles.css?v=9','/player-v2.css?v=9','/site-shell.css?v=9','/polish-v9.css?v=9','/site.js?v=9','/player-v2.js?v=9','/mixer-fx-v9.js?v=9','/scene-audio-v2.js?v=9','/player-shell-v9.js?v=9','/player-shell-v10.js?v=10','/player-controls-v11.js?v=11','/legal-language-v9.js?v=9','/mixer-sources.json','/manifest.webmanifest','/assets/icon.svg','/privacy/','/terms/'];
