...
const APP_SHELL=['/','/player/','/download/','/styles.css?v=9','/player-v2.css?v=9','/site-shell.css?v=9','/polish-v9.css?v=9','/site.js?v=9','/player-v2.js?v=9','/player-runtime.js?v=10','/player-settings-fix.js?v=10','/mixer-sources.json','/manifest.webmanifest','/assets/icon.svg','/privacy/','/terms/'];
