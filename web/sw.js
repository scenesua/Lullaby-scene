const CACHE='lullaby-scene-site-v4';
const APP_SHELL=['/','/styles.css','/player-v2.css','/player-v2.js','/duration-input.js','/mixer-sources.json','/manifest.webmanifest','/assets/icon.svg','/privacy/','/terms/'];
