(()=>{
  ...
  visual.style.setProperty('--scene-exposure','0');frame=requestAnimationFrame(animate);show();injectAmbientToggle();localize();setTimeout(injectDisplayButtons,300);setTimeout(injectDisplayButtons,1000);setTimeout(injectDisplayButtons,1800);
})();
