...
object SourceCatalog {
    val all: List<SourceDefinition> = listOf(
        ...
        SourceDefinition(SourceId.SUBMARINE_SONAR, R.string.source_submarine_sonar, UiCategory.TRAVEL),
        SourceDefinition(SourceId.HOOD_JOURNEY_BED, R.string.source_hood_journey_bed, UiCategory.TRAVEL),
        SourceDefinition(SourceId.HOOD_GUNSHOT, R.string.source_hood_gunshot, UiCategory.TRAVEL),
        SourceDefinition(SourceId.HOOD_SIREN, R.string.source_hood_siren, UiCategory.TRAVEL),
        SourceDefinition(SourceId.HOOD_GLASS, R.string.source_hood_glass, UiCategory.TRAVEL),
        SourceDefinition(SourceId.HOOD_SHOUT, R.string.source_hood_shout, UiCategory.TRAVEL),
        SourceDefinition(SourceId.HOOD_FOOTSTEPS, R.string.source_hood_footsteps, UiCategory.TRAVEL),
        SourceDefinition(SourceId.HOOD_CAR_PASS, R.string.source_hood_car_pass, UiCategory.TRAVEL),
        SourceDefinition(SourceId.HOOD_CAR_DOOR, R.string.source_hood_car_door, UiCategory.TRAVEL),
        SourceDefinition(SourceId.HOOD_HELICOPTER, R.string.source_hood_helicopter, UiCategory.TRAVEL),
        SourceDefinition(SourceId.HOOD_DOG, R.string.source_hood_dog, UiCategory.TRAVEL),
