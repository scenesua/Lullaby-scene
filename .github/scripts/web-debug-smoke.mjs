...
const page=text('web/debug/index.html'),player=text('web/player/index.html'),bridge=text('web/debug-bridge-v1.js'),consoleJs=text('web/debug-console-v1.js'),worker=text('web/_worker.js');
