...
const expected={
  ...
  ferry_journey_departure_001:['ferry_journey','continuous',128667,'4aae7519a1963bdca225655d2ef7fbe8903459a2607c55e13fb9415c7f21456d'],ferry_journey_bed_001:['ferry_journey','continuous',120666,'5583c17eaffda0255f70a12be33634bd0a3e11c05274b203d9e5eb62f958a211'],ferry_journey_arrival_001:['ferry_journey','continuous',98065,'6439ec0e9029126670bcf94b576261e0dbf40e304300b27221e6268b58a51932'],
...
if(!text('web/player/index.html').includes('/remaining-journeys-v1.js?v=27'))throw new Error('Web player does not load remaining Journey runtime');
