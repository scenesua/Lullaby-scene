...
const expected={
  ...
  forest_temple_forest_bed_001:['forest_temple_journey','continuous',226000,'c92ff41bfecf55166d8cdfea5a160572d83a4f44d433964251ed7032dac360f9'],forest_temple_korean_distant_birds_bed_001:['forest_temple_journey','continuous',120030,'1e74a03d24f020ca7a208a5335f1902abc3488d6fb3e46660ab2e7f12224aeeb'],forest_temple_heart_sutra_event_001:['forest_temple_journey','events',120196,'30c52dd70ba9d28f5fdf52e83156c3cd281450bc256c2bbd944c04a6d4034533']
};
...
if(!text('web/player/index.html').includes('/train-journey-v1.js?v=14'))throw new Error('Web player does not load Train Journey runtime');
if(!text('web/player/index.html').includes('/remaining-journeys-v1.js?v=34'))throw new Error('Web player does not load remaining Journey runtime');
